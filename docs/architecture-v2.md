...
**职责定位**: 接收CEO任务，负责工作流编排和进度跟踪

> **核心区别**:
> - 架构师负责"怎么做"（技术方案）
> - PM负责"谁来做"和"什么时候做完"（工作流编排）
...
│                     任务生命周期                                  │
│                                                                  │
│  CEO指令 ──▶ PM ──▶ 架构师(分析设计) ──▶ PM编排工作流 ──▶ 执行Agent│
│   │           │              │                 │              │    │
│   │      接收任务      需求分析+设计        工作流编排        执行   │
│   │           │              │                 │              │    │
│   │           ▼              ▼                 ▼              ▼    │
│   │      ┌─────────────────────────────────────────────────┐     │
│   │      │              任务队列 (Todo List)                 │     │
